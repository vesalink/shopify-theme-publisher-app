...
const developmentPlugins = [new webpack.EnvironmentPlugin(['NODE_ENV']), new webpack.DefinePlugin(compileTimeConstantForMinification), new webpack.BannerPlugin(bannerOptions)];

const productionPlugins = [...developmentPlugins, new webpack.optimize.UglifyJsPlugin({ compress: { warnings: false } })];
